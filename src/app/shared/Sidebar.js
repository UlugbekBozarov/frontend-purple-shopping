...
class Sidebar extends Component {
  ...
  onRouteChanged() {
    ...
    const dropdownPaths = [
      ...
      { path: '/products', state: 'productsMenuOpen' },
      { path: '/member', state: 'membersMenuOpen' },
        ...
        <ul className="nav">
          ...
          {/* <li className="nav-item nav-profile">
            <a href="!#" className="nav-link" onClick={evt => evt.preventDefault()}>
              ...
              <div className="nav-profile-text">
                <span className="font-weight-bold mb-2"><Trans>Project Admin</Trans></span>
          ...
          <li className={this.isPathActive('/orders') ? 'nav-item active' : 'nav-item'}>
            <div className={this.state.ordersMenuOpen ? 'nav-link menu-expanded' : 'nav-link'} onClick={() => this.toggleMenuState('ordersMenuOpen')} data-toggle="collapse">
              ...
              <i className="mdi mdi mdi-cart-outline menu-icon"></i>
            </div>
            <Collapse in={this.state.ordersMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={this.isPathActive('/orders/new-orders') ? 'nav-link active' : 'nav-link'} to="/orders/new-orders"><Trans>New Orders</Trans></Link></li>
                <li className="nav-item"> <Link className={this.isPathActive('/orders/delivery-orders') ? 'nav-link active' : 'nav-link'} to="/orders/delivery-orders"><Trans>Delivery Orders</Trans></Link></li>
                <li className="nav-item"> <Link className={this.isPathActive('/orders/receive-orders') ? 'nav-link active' : 'nav-link'} to="/orders/receive-orders"><Trans>Receive Orders</Trans></Link></li>
              </ul>
            </Collapse>
          </li>
          <li className={this.isPathActive('/categories') ? 'nav-item active' : 'nav-item'}>
            <div className={this.state.categoriesMenuOpen ? 'nav-link menu-expanded' : 'nav-link'} onClick={() => this.toggleMenuState('categoriesMenuOpen')} data-toggle="collapse">
            ...
            <Collapse in={this.state.categoriesMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={this.isPathActive('/categories/category') ? 'nav-link active' : 'nav-link'} to="/categories/category"><Trans>Category</Trans></Link></li>
              </ul>
            </Collapse>
          </li>
          <li className={this.isPathActive('/products') ? 'nav-item active' : 'nav-item'}>
            ...
            <Collapse in={this.state.productsMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={this.isPathActive('/products/get-products') ? 'nav-link active' : 'nav-link'} to="/products/get-products"><Trans>Products</Trans></Link></li>
                <li className="nav-item"> <Link className={this.isPathActive('/products/add-product') ? 'nav-link active' : 'nav-link'} to="/products/add-product"><Trans>Add Product</Trans></Link></li>
                <li className="nav-item"> <Link className={this.isPathActive('/products/edit-product') ? 'nav-link active' : 'nav-link'} to="/products/edit-product"><Trans>Edit Product</Trans></Link></li>
              </ul>
            </Collapse>
          </li>
          <li className={this.isPathActive('/member') ? 'nav-item active' : 'nav-item'}>
            <div className={this.state.membersMenuOpen ? 'nav-link menu-expanded' : 'nav-link'} onClick={() => this.toggleMenuState('membersMenuOpen')} data-toggle="collapse">
              <span className="menu-title"><Trans>Member</Trans></span>
              <i className="menu-arrow"></i>
              <i className="mdi mdi-account-multiple menu-icon"></i>
            </div>
            <Collapse in={this.state.membersMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={this.isPathActive('/member/members') ? 'nav-link active' : 'nav-link'} to="/member/members"><Trans>Members</Trans></Link></li>
                {/* <li className="nav-item"> <Link className={ this.isPathActive('/products/add-product') ? 'nav-link active' : 'nav-link' } to="/products/add-product"><Trans>Add Product</Trans></Link></li> */}
                {/* <li className="nav-item"> <Link className={ this.isPathActive('/products/edit-product') ? 'nav-link active' : 'nav-link' } to="/products/edit-product"><Trans>Edit Product</Trans></Link></li> */}
              </ul>
            </Collapse>
