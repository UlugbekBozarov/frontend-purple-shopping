...
const NewOrders = () => {
    ...
    const setStatusDelivery = (id) => (e) => {
        e.preventDefault();

        axios.get(
            "/order/status/delivery/" + id,
            {
                headers: {
                    Authorization: localStorage.getItem("Online-Shopping Authorization")
                }
            ...
            setOrdersCollapse(bool);
            successfulAlert("Order Delivery");
        }).catch(err => {
                ...
                <li onClick={updateCollapse(index - 1)}>
                    <div className={ordersCollapse[index - 1] ? 'li-order menu-expanded' : 'li-order'}>
                        <div style={{ width: "100px" }}>
                            <img className="w-100 h-100 rounded-circle" src={order.user.user_image} alt={order.user.fullname} />
                        </div>
                        ...
                        <div className="border border-primary border-top-0">
                            ...
                            <div>
                                ...
                                <div className="d-flex justify-content-between py-3">
                                    <div>
                                        <h4>Total Price: <span className="text-primary">{order.grant_total} </span><small className="text-muted">(so'm)</small></h4>
                                    </div>
                                    <div>
                                        <button className="btn btn-primary" onClick={setStatusDelivery(order.order_id)}>
                                            <i className="mdi mdi-truck-delivery pr-2"></i>
                                            <span>Delivery</span>
                                        </button>
                                    </div>
                                </div>
            ...
            <div className="bg-white box-shadow p-2 p-md-3">
                ...
                <div className="d-flex justify-content-between">
                    <div className="d-flex align-items-center">
                        ...
                        <h5 className="m-0">New Orders</h5>
                    </div>
                    {/* <div>
