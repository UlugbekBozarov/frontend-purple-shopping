            ...
            return (
                <li onClick={updateCollapse(index - 1)}>
                    <div className={ordersCollapse[index - 1] ? 'li-order menu-expanded' : 'li-order'}>
                        ...
                        <div className="pl-3" style={{ width: "350px" }}>
            ...
            <div className="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">Receive Order</li>
                    </ol>
                </nav>
            </div>
            ...
            <div className="bg-white box-shadow p-2 p-md-3">
                ...
                <div className="d-flex justify-content-between">
                    <div className="d-flex align-items-center">
                        ...
                        <h5 className="m-0">Receive Orders</h5>
                    </div>
                    {/* <div>
                ...
                </div>
                {
                    orders.length > 0 ? (
                        <div className="mt-4 scroll" >
                            <ul className="p-2" style={{ minWidth: "1150px" }}>
                                <hr />
                                {renderReceiveOrders()}
                            </ul>
                        </div>
